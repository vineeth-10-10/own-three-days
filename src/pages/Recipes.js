...
const Recipes = () => {
  ...
  const handleDeleteRecipe = async (id) => {
    try {
      await axios.delete(
        `https://ownthreedays-default-rtdb.firebaseio.com/recipe/${id}.json`
      );
        ...
        <Modal.Body>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                setCurrentRecipe({ ...currentRecipe, price: e.target.value })
              }
            />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                setCurrentRecipe({ ...currentRecipe, imageUrl: e.target.value })
              }
            />
          </div>
          <div className="form-group">
